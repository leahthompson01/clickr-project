...
export default function TodoForm() {
    ...
    return (
        <form
            onSubmit={submit}
            className={
                'bg-blue flex flex-row items-center justify-center gap-4 py-4 text-black'
            }
        >
            ...
            >
                <ListboxButton
                    className={clsx(
                        'relative block w-40 rounded-lg bg-gray-700/40 py-1.5 pl-3 pr-8 text-left text-sm/6 text-black',
            ...
            <button className={'h-10 w-24 rounded-md bg-black text-gray-100'}>
                Submit
            </button>
        </form>
    );
